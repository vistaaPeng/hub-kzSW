...
if __name__ == "__main__":
    main()
    # 测试样例
    # test_vec = [[0.9, 0.1, 0.2, 0.3, 0.4],  # 应该预测为0
    #             [0.1, 0.9, 0.2, 0.3, 0.4],  # 应该预测为1
    #             [0.1, 0.2, 0.9, 0.3, 0.4],  # 应该预测为2
    #             [0.1, 0.2, 0.3, 0.9, 0.4],  # 应该预测为3
    #             [0.1, 0.2, 0.3, 0.4, 0.9]]  # 应该预测为4
