...
echo "=== Step 2: 重训 BQ BiCosine (3ep) ==="
/root/miniconda3/bin/python src/train_biencoder.py --loss cosine --data_dir data/bq_corpus --epochs 3

echo "=== Step 3: 换入 BQ CrossEncoder ==="
...
echo ""
echo "=== DONE ==="
echo "拉回: scp -P 28197 root@connect.cqa1.seetacloud.com:/root/autodl-tmp/text_match/outputs/logs/two_stage_bq_corpus.json ."
