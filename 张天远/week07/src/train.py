...
def main():
    ...
    print(f"数据集：{args.dataset} | BIO 标签数：{num_labels}（O + {len(labels) - 1} 个实体标签）")
    ...
    print(f"\n开始训练（{args.dataset} + {'CRF' if args.use_crf else 'Linear'}）...")
