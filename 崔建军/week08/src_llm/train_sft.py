...
使用方式：
  ...
  python train_sft.py --num_train -1         # LoRA，全部训练数据
...
MODEL_PATH = "D:/BaiduNetdiskDownload/AI/pretrain_models/Qwen2.5-0.5B-Instruct"  # 本地模型
