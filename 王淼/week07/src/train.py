...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_f1 > best_f1:
            ...
            print(f"  [NEW BEST] F1={val_f1:.4f}, saved to {ckpt_path}")
...
def parse_args():
    ...
    # 快速模式参数
    parser.add_argument("--quick", action="store_true", help="快速模式：使用少量数据（1000训练+200验证）")
    parser.add_argument("--num_train", type=int, default=-1, help="训练数据量，-1使用全部")
    parser.add_argument("--num_val", type=int, default=-1, help="验证数据量，-1使用全部")
