...
def main():
    parser = argparse.ArgumentParser(description="文献 RAG 消融实验")
    parser.add_argument("--strategies", type=str, default="semantic",
                        help="逗号分隔策略: fixed,semantic,hierarchical")
    parser.add_argument("--modes", type=str, default="vector_only,hybrid",
                        help="逗号分隔检索方式: vector_only,bm25_only,hybrid")
