"""
CrossEncoder 训练脚本（LCQMC 交互型文本匹配）
...
def main():
    ...
    # LCQMC 正负比约，CrossEntropyLoss 默认不加权
...
def parse_args():
    parser = argparse.ArgumentParser(description="CrossEncoder 训练（LCQMC 交互型文本匹配）")
