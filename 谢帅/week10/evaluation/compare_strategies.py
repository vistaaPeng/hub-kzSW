...
# 消融实验用的题（取 questions.json 中有明确 target_docs 的题，覆盖三份文档）
ABLATION_QUESTION_IDS = [1, 2, 3, 4, 5, 6, 7, 8, 9]
...
def compute_metrics(
    ...
    for q in questions:
        ...
        # 判断命中：retrieved 的 doc_id 是否覆盖了目标文档
        hit_any = False
        first_rank = None
        for i, item in enumerate(retrieved, 1):
            if item.get("doc_id", "") in target_docs:
                hit_any = True
