...
使用方式：
  python src/evaluate_practice.py                        # 评估 BERT+Linear
  python src/evaluate_practice.py --use_crf              # 评估 BERT+CRF
  python src/evaluate_practice.py --split test           # 在测试集上评估
